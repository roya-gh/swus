...
struct ns2__loginResponse
{
    ...
    xsd__integer                        :errorCode;	///< Output parameter, : unqualified name as per RPC encoding
    std::string                         :errorString;	///< Output parameter, : unqualified name as per RPC encoding
    std::string                         :token;	///< Output parameter, : unqualified name as per RPC encoding
    xsd__integer                        :ttl;	///< Output parameter, : unqualified name as per RPC encoding
};
